...
TEST(fpls_a_test, laplacian_samplingatnodes_sequential_off) {
    // define domain
    ...
    FPLS_A<SpaceOnly> model(pde, Sampling::mesh_nodes, rsvd);   // functional partial least squares model
...
TEST(fpls_a_test, laplacian_samplingatnodes_sequential_gcv) {
    // define domain
    MeshLoader<Mesh2D> domain("unit_square");
    // import data from files
    ...
    FPLS_A<SpaceOnly> model(pde, Sampling::mesh_nodes, rsvd);   // functional partial least square models
